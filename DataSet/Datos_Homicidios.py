...
with open('Homicidios.csv', 'wb') as myfile:
    ...
    for nombre, datos in c:
    	for a,b in zip(datos['Hora Infraccion'],datos['tipo_muert_matriz']):
    		if (a > '2015-12-02T00:00:00') & (a <= '2015-12-02T06:00:00') & (b=='Homicidios'):
    			madrugada = madrugada +1
    		if (a > '2015-12-02T06:00:00') & (a <= '2015-12-02T12:00:00') & (b=='Homicidios'):
    			manana = manana +1
    		if (a > '2015-12-02T12:00:00') & (a <= '2015-12-02T18:00:00') & (b=='Homicidios'):
    			tarde = tarde +1
    		if (a > '2015-12-02T18:00:00') & (a <= '2015-12-02T23:59:59') & (b=='Homicidios'):
    			noche = noche +1 
